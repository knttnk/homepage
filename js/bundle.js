...
class SurfacePositionController {
    ...
    async position() {
         ...
         *
         * 笏娯楳笏笏笏笏 inline/blockDocumentOffset  inlineScrollbarWidth
         * 笏・      笏・                                   笏・         * 笏・    笏娯楳笆ｼ笏笏笏笏笏笏・                             笏・ocument
         * 笏・   笏娯半笏笏笏笏笏笏笏笏ｴ笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏ｼ笏笏笏笏笏笏笏笏笏・         * 笏・   笏や狽                                      笏・       笏・         * 笏披楳笏笆ｺ 笏や狽 笏娯楳笏笏笏笏 inline/blockWindowOffset      笏・       笏・         *      笏や狽 笏・      笏・                           笆ｼ        笏・         *      笏や狽 笏・    笏娯楳笆ｼ笏笏笏笏・                Window笏娯柏        笏・         *      笏披筈 笏・   笏娯半笏笏笏笏笏笏ｴ笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏ｼ笏・       笏・         *       笏・笏・   笏や狽                             笏や狽        笏・         *       笏・笏披楳笏笆ｺ 笏や狽  笏娯楳笏inline/blockAnchorOffset笏や狽        笏・         *       笏・     笏や狽  笏・    笏・                   笏や狽        笏・         *       笏・     笏披筈  笏・ 笏娯楳笏笆ｼ笏笏笏笏・               笏や狽        笏・         *       笏・      笏・ 笏・笏娯半笏笏笏笏笏笏笏､                笏や狽        笏・         *       笏・      笏・ 笏披楳笆ｺ笏・nchor笏・               笏や狽        笏・         *       笏・      笏・   笏披閥笏笏笏笏笏笏笏・               笏や狽        笏・         *       笏・      笏・                            笏や狽        笏・         *       笏・      笏・    笏娯楳笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏ｼ笏ｼ笏笏笏笏笏・  笏・         *       笏・      笏・    笏・Surface               笏や狽    笏・  笏・         *       笏・      笏・    笏・                      笏や狽    笏・  笏・         *       笏・      笏・    笏・                      笏や狽    笏・  笏・         *       笏・      笏・    笏・                      笏や狽    笏・  笏・         *       笏・      笏・    笏・                      笏や狽    笏・  笏・         *       笏・     笏娯半笏笏笏笏笏笏ｼ笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏ｼ笏・   笏・  笏・         *       笏・  笏娯楳笆ｺ笏ｴ笏笏笏笏笏笏笏ｼ笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏・   笏懌柏  笏・         *       笏・  笏・        笏・inline/blockOOBCorrection   笏や狽  笏・         *       笏・  笏・        笏・                        笏・  笏や狽  笏・         *       笏・  笏・        笏・                        笏懌楳笏笆ｺ笏懌狽  笏・         *       笏・  笏・        笏・                        笏・  笏や狽  笏・         *       笏・  笏・        笏披楳笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏絶名笏笏笏笏ｼ笏・ 笏・         *       笏・ blockScrollbarHeight                笏披楳笏笏笏笏・  笏・         *       笏・                                              笏・         *       笏披楳笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏笏・         */
 ...
 * They窶决e used to represent the most important action on a screen, such as
 * Create or Reply.
 *
 * @description
 * __Emphasis:__ High emphasis 窶・For the primary, most important, or most common
 * action on a screen
 *
 * __Rationale:__ The FAB remains the default component for a screen窶冱 primary
 * action. It comes in three sizes: small FAB, FAB, and large FAB. The extended
 * FAB窶冱 wider format and text label give it more visual prominence than a  FAB.
 * It窶冱 often used on larger screens where a FAB would seem too small.
 *
 * __Example usages:__
 * - FAB
 *   - Create
