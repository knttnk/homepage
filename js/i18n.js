    ...
    en: {
      translation: {
        ...
        products: {
          products: "Products",
          product1: "NQLib",
          description1: "Python library to design noise shaping quantizer for discrete-valued input control.",
          ...
          product3: "iscie.bst",
          description3: "Unofficial BibTeX style file for ISCIE.",
          product4: "Snippet Utilities",
          description4: "VSCode extension to easily register code snippets.",
        },
        contact: {
          contact: "Contact",
    ...
    ja: {
      translation: {
        ...
        products: {
          products: "制作物",
          product1: "NQLib",
          description1: "Pythonによる，離散値制御のための動的量子化器の設計ライブラリ．",
          product2: "The Inverted Pendulum Game",
          description2: "情報改変の効果を体験できる，倒立振子を制御するゲーム．",
          product3: "iscie.bst",
          description3: "非公式のISCIE用BibTeXスタイルファイル．",
          product4: "Snippet Utilities",
          description4: "VSCodeでコードのテンプレを簡単に登録するための拡張機能．",
        },
        contact: {
          contact: "連絡先",
          lab: "石川・南研究室",
