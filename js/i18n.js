    ...
    en: {
      translation: {
        ...
        products: {
          ...
          "ipgame-description": "A game to control an inverted pendulum (now closed to the public). You can experience the effect of information alteration.",
          "iscie-bst": "iscie.bst",
    ...
    ja: {
      translation: {
        ...
        products: {
          ...
          "ipgame": "The Inverted Pendulum Game",
          "ipgame-description": "情報改変の効果を体験できる，倒立振子を制御するゲーム（公開停止中）．",
          "iscie-bst": "iscie.bst",
